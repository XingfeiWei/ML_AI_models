...
torch.save(resnetNN.state_dict(), './resnet50_trained.pth')
...
state_dict = torch.load('./resnet50_trained.pth')
...
torch.save(resnetNN.state_dict(), './fine_tuned_resnet50.pth')
...
state_dict = torch.load('./fine_tuned_resnet50.pth')
