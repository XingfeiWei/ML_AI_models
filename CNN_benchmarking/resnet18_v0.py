...
resnetNN = models.resnet18(weights=ResNet18_Weights.DEFAULT)
...
torch.save(resnetNN.state_dict(), './resnet18_trained.pth')
...
state_dict = torch.load('./resnet18_trained.pth')
...
torch.save(resnetNN.state_dict(), './fine_tuned_resnet18.pth')
